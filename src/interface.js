...
/* exported Calculator enable disable */
...
var Calculator = GObject.registerClass({
    ...
    constructor(properties = {}) {
        ...
        this._launcher.add_child(new St.Icon({
    ...
    _initRegister(stackBox, label, font) {
    ...
    _initIndicator(indicatorArea, font) {
