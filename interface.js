...
var Calculator = GObject.registerClass(
    class Calculator extends PanelMenu.Button {
        ...
        _initRegister(stackBox, label) {
            ...
            value.set_style(`font-family: ${this._fontFamily}`);
            ...
            name.set_style(`font-family: ${this._fontFamily}`);
        ...
        _initStack(stackArea) {
            ...
            this._x1RegisterLabel = this._initRegister(stack1Box, "X\u{2081}");
            this._tRegisterLabel = this._initRegister(stack2Box, "T");
            this._zRegisterLabel = this._initRegister(stack2Box, "Z");
            this._yRegisterLabel = this._initRegister(stack2Box, "Y");
            this._xRegisterLabel = this._initRegister(stack2Box, "X");
        ...
        _initIndicator(indicatorArea) {
            ...
            this._mantissaIndicatorLabel.set_style(`font-family: ${this._fontFamily}`);
            ...
            this._exponentIndicatorLabel.set_style(`font-family: ${this._fontFamily}`);
                    ...
                    if (key.buttonId != Processor.Processor.Key.RESERVED_NULL) {
                        ...
                        if (row.labels == true) {
                            ...
                            if (key.labelF != "") {
                                ...
                                let labelF = new St.Label({
                                    text: key.labelF,
                                    x_align: Clutter.ActorAlign.CENTER,
                                    y_align: Clutter.ActorAlign.END,
                                    style_class: 'panel-calc-rpn-labelFLabel'
                                });
                                labelF.set_style(`font-family: ${this._fontFamily}`);
                            ...
                            if (key.labelK != "") {
                                ...
                                let labelK = new St.Label({
                                    text: key.labelK,
                                    x_align: Clutter.ActorAlign.CENTER,
                                    y_align: Clutter.ActorAlign.END,
                                    style_class: 'panel-calc-rpn-labelKLabel'
                                });
                                labelK.set_style(`font-family: ${this._fontFamily}`);
